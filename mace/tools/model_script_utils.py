...
def configure_model(
    ...
    output_args = {
        ...
        "charges": getattr(args, "use_electrostatics", False),
    }
    logging.info(
    ...
    if model_foundation is not None and args.model in [
        ...
        model_config = dict(
            ...
            use_electrostatics=getattr(args, "use_electrostatics", False),
            hardness_init=getattr(args, "hardness_init", {}),
            covalent_radii=getattr(args, "covalent_radii", {}),
        )
