...
def build_default_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--use_electrostatics",
        help="Enable 4th Generation Equivariant Electrostatics",
        type=str2bool,
        default=False,
    )
    parser.add_argument(
        "--hardness_init",
        help="Dictionary of initial hardness values (J) for QEq. Pass as JSON string or handle via config file.",
        type=str,
        default=None,
    )
    parser.add_argument(
        "--covalent_radii",
        help="Dictionary of covalent radii (sigma) for Gaussian electrostatics. Pass as JSON string or handle via config file.",
        type=str,
        default=None,
    )
    # Fine-tuning
    ...
    parser.add_argument(
        "--charges_weight", 
        help="Weight of the charge equilibration loss (MSE between predicted and DFT charges)", 
        type=float, 
        default=1.0
    )
    parser.add_argument(
